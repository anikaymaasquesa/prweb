...
<html lang="es">
    ...
    <head>
        ...
        <link href="css/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="css/pages/admin/login-4.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="js/plugins/js.cookie.min.js" type="text/javascript"></script>
        ...
        <script src="js/pages/admin/login/login-4.js" type="text/javascript"></script>
